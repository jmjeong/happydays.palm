...
typedef struct {
    UInt	renamedCategories;	// bitfield of categories with a different
                                // name
...
extern Err ApptNewRecord (DmOpenRef dbP, ApptDBRecordPtr r, UInt *index);
extern VoidHand ApptGetAppointments (DmOpenRef dbP, DateType date, UIntPtr
                                     countP);
extern Err ApptGetRecord (DmOpenRef dbP, UInt index, ApptDBRecordPtr r,
                   VoidHand * handleP);
extern Err ApptChangeRecord(DmOpenRef dbP, UInt *index, ApptDBRecordPtr r,
